...
public class StravaConnectionFactory extends OAuth2ConnectionFactory<Strava> {
	...
	/**
	 * Creates a factory for Strava connections.
	 * 
	 * @param clientId client ID
	 * @param clientSecret client secret
	 */
	public StravaConnectionFactory(String clientId, String clientSecret) {
		super("strava", new StravaServiceProvider(clientId, clientSecret), new StravaAdapter());
	}
